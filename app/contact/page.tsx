...
export default function ContactPage() {
  ...
  return (
    <div style={{ paddingTop: 90, background: "#faf9f7", minHeight: "100vh" }}>
      ...
      <section style={{ padding: "72px 20px", background: "#ffffff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div className="contact-grid">
            {/* ── Info column ── */}
            <div>
              <h2 style={{ color: "#1a1a1a", fontWeight: 800, fontSize: 22, marginBottom: 28 }}>
              ...
              {[
                ...
                <div key={c.label} className="card-glass" style={{ padding: 20, marginBottom: 14, display: "flex", gap: 14, alignItems: "flex-start", background: "#ffffff", border: "1px solid #ede9e0", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
                  <div style={{ fontSize: 26, flexShrink: 0 }}>{c.icon}</div>
                  <div>
                    <div style={{ color: "#d4900a", fontWeight: 700, fontSize: 13, marginBottom: 4 }}>{c.label}</div>
                    <div style={{ color: "#666", fontSize: 14 }}>{c.value}</div>
                  </div>
                </div>
              ))}

              <div className="card-glass" style={{ padding: 24, marginTop: 20, background: "#ffffff", border: "1px solid #ede9e0", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
                <h3 style={{ color: "#d4900a", fontWeight: 700, fontSize: 15, marginBottom: 14 }}>Office Hours</h3>
                {[
                  ...
                  <div key={day} style={{
                    ...
                    <span style={{ color: "#d4900a", fontWeight: 600 }}>{hours}</span>
                  </div>
                ))}
              </div>

              <div style={{ marginTop: 24 }}>
                <h3 style={{ color: "#1a1a1a", fontWeight: 700, fontSize: 14, marginBottom: 14 }}>We Serve</h3>
                <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
                  {["🇮🇳 India", "🇦🇪 UAE", "🇺🇸 USA", "🇩🇪 Germany", "🌍 Africa", "🌏 Europe"].map((m) => (
                    <span key={m} style={{
                      background: "rgba(212,144,10,0.1)", border: "1px solid rgba(212,144,10,0.3)",
                      color: "#b07808", fontSize: 12, padding: "6px 12px", borderRadius: 100, fontWeight: 600,
                    }}>{m}</span>
                  ))}
                </div>
              </div>
            ...
            <div>
              ...
              {submitted ? (
                <div className="card-glass" style={{ padding: 48, textAlign: "center", background: "#ffffff", border: "1px solid #ede9e0", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
                  <div style={{ fontSize: 56, marginBottom: 14 }}>✅</div>
                  <h3 style={{ color: "#d4900a", fontSize: 20, fontWeight: 700, marginBottom: 12 }}>Inquiry Received!</h3>
                ...
                <form onSubmit={handleSubmit} className="card-glass" style={{ padding: 32, background: "#ffffff", border: "1px solid #ede9e0", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
                  <div className="form-row-2">
                    <div>
                      <label style={{ color: "#666", fontSize: 13, display: "block", marginBottom: 8, fontWeight: 600 }}>Your Name *</label>
                      <input required placeholder="Full name" value={formData.name}
                        onChange={(e) => setFormData({ ...formData, name: e.target.value })} />
                    </div>
                    <div>
                      <label style={{ color: "#666", fontSize: 13, display: "block", marginBottom: 8, fontWeight: 600 }}>Company Name</label>
                  ...
                  <div className="form-row-2">
                    <div>
                      <label style={{ color: "#666", fontSize: 13, display: "block", marginBottom: 8, fontWeight: 600 }}>Service Required *</label>
                    ...
                    <div>
                      <label style={{ color: "#666", fontSize: 13, display: "block", marginBottom: 8, fontWeight: 600 }}>Number of Workers</label>
                  ...
                  <div style={{ marginBottom: 24 }}>
                    <label style={{ color: "#666", fontSize: 13, display: "block", marginBottom: 8, fontWeight: 600 }}>Message / Requirements</label>
                    <textarea rows={5}
      ...
      {/* Map placeholder */}
      <section style={{ padding: "0 20px 72px", background: "#ffffff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div className="card-glass" style={{ height: 260, display: "flex", alignItems: "center", justifyContent: "center", flexDirection: "column", gap: 10, background: "#ffffff", border: "1px solid #ede9e0", boxShadow: "0 2px 12px rgba(0,0,0,0.05)" }}>
            <div style={{ fontSize: 44 }}>📍</div>
            <div style={{ color: "#d4900a", fontWeight: 700, fontSize: 17, textAlign: "center" }}>Serving Clients Across India &amp; Internationally</div>
            <div style={{ color: "#888", fontSize: 13, textAlign: "center" }}>Pan-India presence with global reach to UAE, USA, Germany, Europe &amp; Africa</div>
          </div>
        </div>
      </section>
    </div>
